        ...
        class ReasonModal(discord.ui.Modal, title="Обновление статуса"):
            ...
            async def update_user_status_change(self, user_id, mc_username):
                ...
                if user:
                    ...
                    forms_done.append({"mc_nickname": mc_username, "status": "decline", "approve_time": datetime.now().strftime('%Y-%m-%d %H:%M:%S')})
                    ...
                    new_user = {
                        ...
                        "forms_done": [{"mc_nickname": mc_username, "status": "decline", "approve_time": datetime.now().strftime('%Y-%m-%d %H:%M:%S')}]
                    }
