...
PRODUCTS = [
    {"name": "Кастомная пластинка 1шт.", "cost": 200, "description": "Эксклюзивная кастомная пластинка для вашего использования."},
    {"name": "Кастомная пластинка 3шт.", "cost": 450, "description": "Три уникальные кастомные пластинки с выгодой."},
    {"name": "Откат инвентаря", "cost": 450, "description": "Восстановление вашего инвентаря после потери."},
    {"name": "Разбан", "cost": 1000, "description": "Снятие блокировки с вашего аккаунта."},
    {"name": "Кастомная голова 1шт.", "cost": 65, "description": "Создание уникальной кастомной головы."},
    {"name": "Кастомная голова 3шт.", "cost": 185, "description": "Три кастомные головы по сниженной цене."},
    {"name": "Картинка на карте 1шт.", "cost": 35, "description": "Добавление изображения на одну карту."},
    {"name": "Картинка на карте 10шт.", "cost": 350, "description": "Десять изображений на карте с выгодой."},
    {"name": "Кастомный лор и имя предмета", "cost": 150, "description": "Уникальное описание и имя для предмета."},
    {"name": "Смена аккаунта", "cost": 80, "description": "1 покупка — 1 смена аккаунта."},
    {"name": "Смена роста", "cost": 300, "description": "Доступные размеры: 0.7, 1 и 1.3."},
    {"name": "Снятие мута", "cost": 149, "description": "Снятие мута с вашего аккаунта."},
    {"name": "Выпустить из тюрьмы", "cost": 179, "description": "Освобождение из тюрьмы."},
]